...
def main(args):
  ...
  if len(args.model)>0:
    ...
    cvd = os.environ['CUDA_VISIBLE_DEVICES'] = '0,1,2'
    if len(cvd)>0:
...
if __name__ == '__main__':
  ...
  # general
  parser.add_argument('--include', default='/mnt/hdd/cheolhui/ms1m+vgg+glintasia+glint+casia,/mnt/hdd/cheolhui/faces_umd', type=str, help='')
  parser.add_argument('--exclude', default='', type=str, help='')
  parser.add_argument('--output', default='/mnt/hdd/cheolhui/ms1m+vgg+glintasia+glint+casia+umd', type=str, help='')
