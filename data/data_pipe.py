...
def get_train_loader(conf):
    if conf.data_mode in ['ms1m', 'concat']:
        imgs_folder = os.path.join(conf.ms1m_folder, 'imgs')
        ms1m_ds, ms1m_class_num = get_train_dataset(imgs_folder)
        print('ms1m loader generated')
    if conf.data_mode in ['vgg', 'concat']:
        imgs_folder = os.path.join(conf.vgg_folder, 'imgs')
        vgg_ds, vgg_class_num = get_train_dataset(imgs_folder)
    ...
    if conf.data_mode == 'vgg':
        ...
        imgs_folder = os.path.join(conf.emore_folder, 'imgs')
        ds, class_num = get_train_dataset(imgs_folder)
